...
const myPow = (a, b, print) => {
    let calcPow = (x, y) => y!==1 ? x *= calcPow(x, y - 1) : x;
    return print(a,b,calcPow(a,b));
}
...
let car = {
    ...
    set used(data) {
        if (data === 'new' && this.year !== yearNow) this.year = yearNow;
    }
}
...
let notUniqStrings = ['Bob', 'Kate', 'John', 'Tom', 'John', 'Kate', 'Tom', 'Bob', 'John', 'Tom', 'Dumitru', 'Dumitru'];
